      ...
      <div className="w-full max-w-5xl bg-white/95 backdrop-blur-xl rounded-3xl p-8 border border-blue-100/50 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div 
            ...
            className="bg-gradient-to-r from-blue-500 to-teal-400 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1"
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold">View My Records</h3>
                <p className="text-white/80 mt-1">Access your medical records by tier</p>
              </div>
            </div>
          </div>
        </div>
