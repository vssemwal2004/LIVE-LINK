            ...
            <button
              ...
              className={`flex items-center space-x-2 px-5 py-2 rounded-lg font-semibold text-sm transition-all duration-300 ${
                Array.isArray(user.primaryDoctors) && user.primaryDoctors.length >= 1
                  ...
                  : 'bg-gradient-to-r from-blue-700 to-teal-600 text-white shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40 transform hover:-translate-y-1'
              }`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                  ...
                  <div className="flex items-center space-x-4 relative z-10">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="bg-gradient-to-r from-red-600 to-red-700 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 text-sm flex items-center space-x-2"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {showAdd && (!Array.isArray(user.primaryDoctors) || user.primaryDoctors.length === 0) && (
            <div className="mt-8 bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-blue-100/50 animate-fade-in">
              ...
              {searchResult && (
                <div
                  data-animate-card
                  className="bg-white/90 backdrop-blur-md rounded-xl p-5 flex items-center justify-between shadow-lg border border-blue-100/50 transition-all duration-500 hover:shadow-xl hover:-translate-y-1"
                >
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center shadow-md">
