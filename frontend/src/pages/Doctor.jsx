          ...
          <div className="mt-8 bg-white/80 backdrop-blur-lg rounded-2xl p-6 border border-blue-100/50 animate-fade-in">
            ...
            <div className="flex gap-3 mb-6 flex-wrap">
              {['early', 'emergency', 'critical'].map((t) => (
                ...
                >
                  ...
                  <span>{t.charAt(0).toUpperCase() + t.slice(1)} Access</span>
                </button>
              ))}
            </div>
            ...
            {existing && (
              <div className="mb-4 text-sm text-blue-600">
                Editing existing {tier} record from {new Date(existing.createdAt).toLocaleString()}
              </div>
            )}
            ...
            <div className="mt-8 border-t pt-6">
              <h4 className="text-lg font-semibold text-blue-800 mb-4 flex items-center space-x-2">
                ...
                <span>Add Section to {tier.charAt(0).toUpperCase() + tier.slice(1)} Record</span>
              </h4>
