      ...
      <div className="w-full md:w-2/5 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl shadow-blue-500/20 p-6 border border-blue-100">
          <div className="text-center mb-6">
            ...
            <p className="text-blue-700 text-sm">Create your healthcare account</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            {role === 'doctor' && (
              <div>
                <label className="block text-sm font-semibold text-blue-800 mb-1">Medical ID</label>
                <div className="relative">
                  <input
                    name="medicalId"
            ...
            <div>
              <label className="block text-sm font-semibold text-blue-800 mb-1">Confirm Password</label>
              <div className="relative">
                <input
          ...
          <div className="mt-4 text-center">
            <p className="text-blue-700 text-sm">
              ...
              <button onClick={() => navigate('/login')} className="font-semibold text-blue-800 hover:text-blue-950 transition-colors">
                Back to Login
              </button>
            </p>
          </div>
